  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <div className="relative w-16 h-16 flex items-center justify-center">
        ...
        <span
          className={`absolute text-sm font-bold ${selectedColor.split(" ")[0]}`}
        >
          {score}
        </span>
      </div>
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center mb-16 pt-12 md:pt-16">
          ...
          <p className="text-lg text-slate-300 leading-relaxed max-w-2xl">
            ...
            Lighthouse. While most agencies settle for "good enough," I deliver
            perfection across every metric.
          </p>
        </div>
          ...
          {lighthouseScores.map((site, index) => (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-y-6 gap-x-2">
                <ScoreRing
                  score={site.performance}
                  label="Performance"
                  color={site.color}
                  delay={0.2 + index * 0.1}
                />
                <ScoreRing
                  score={site.accessibility}
                  label="Accessibility"
                  color={site.color}
                  delay={0.3 + index * 0.1}
                />
                <ScoreRing
                  score={site.bestPractices}
