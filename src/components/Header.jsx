        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="outline" className="border-cyan-500/50 text-cyan-400 hover:bg-cyan-500/10 gap-2">
          ...
          <Button asChild className="ml-4 px-6 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg group">
            <a 
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col p-4 gap-4">
              ...
              <p className="text-sm font-semibold text-slate-500 uppercase">Case Studies</p>
              <Link 
              ...
              <Button asChild className="mt-4 px-6 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg group">
                <a 
                  href="https://inlanltghistyetrlprg.supabase.co/storage/v1/object/public/Site%20Media/JeremyOch_Resume.pdf" 
                  target="_blank" 
                  rel="noopener noreferrer" 
