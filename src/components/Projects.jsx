  ...
  const projects = [
    {
      ...
      description: 'A masterpiece of optimization. Achieving perfect 100/100 scores in Accessibility and SEO with 95 Performance, this site defines the modern "Top 1%" standard.',
      // Replaced with Supabase URL
      image: 'https://inlanltghistyetrlprg.supabase.co/storage/v1/object/public/Site%20Media/ProjectMeanings.avif',
    ...
    },
    {
      ...
      category: 'E-Commerce',
      description: 'A high-performance e-commerce experience showcasing delicate bonsai trees with rich media without sacrificing load speeds.',
      // Replaced with Supabase URL
      image: 'https://inlanltghistyetrlprg.supabase.co/storage/v1/object/public/Site%20Media/ProjectBonsai.avif',
    ...
    },
    {
      ...
      description: 'Professional drone photography portfolio featuring high-resolution galleries optimized for instant viewing on mobile networks.',
      // Replaced with Supabase URL
      image: 'https://inlanltghistyetrlprg.supabase.co/storage/v1/object/public/Site%20Media/ProjectDrone.avif',
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div className="max-w-3xl">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Featured Case Studies</h2>
            ...
            <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-800 mb-6 backdrop-blur-sm">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-bold text-white mb-2">Integrated Operations in Action</h4>
                  <p className="text-slate-400 text-sm leading-relaxed">
                    These aren't just coding projects. Each case study demonstrates the full "Integrated Digital Operator" chain: 
                    <span className="text-blue-400 font-medium"> Build → Optimize → Market → Automate → Measure → Deploy → Iterate.</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-lg inline-flex">
              ...
              <span className="text-sm font-bold">All projects engineered to Top 1% Performance Standards</span>
            </div>
          </div>
          
          <Link to="/#contact" className="hidden md:flex items-center gap-2 text-slate-400 hover:text-white transition-colors group self-end mb-2">
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                <div className="text-xs font-bold text-cyan-400 mb-2 uppercase tracking-wider">{project.category}</div>
                <h3 className="text-2xl font-bold mb-3 text-white group-hover:text-cyan-400 transition-colors">
                  <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="hover:underline decoration-cyan-400 decoration-2 underline-offset-4">
                    {project.title}
                  </a>
                </h3>
        ...
        <div className="mt-12 text-center md:hidden">
          <Link to="/#contact" className="inline-flex items-center gap-2 text-slate-400 hover:text-white transition-colors">
