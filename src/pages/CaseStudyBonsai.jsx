...
import { ArrowLeft, TrendingUp, Search, MousePointer, Eye, Activity, Calendar, Server, DollarSign, Clock, ShieldCheck } from 'lucide-react';
import { Link } from 'react-router-dom';

const CaseStudyBonsai = () => {
  // Data for Bonsai (Organic Growth)
  const data = [
    { month: 'Jan 25', clicks: 47, impressions: 2200, ctr: 2.14, position: 32.0 },
    { month: 'Feb 25', clicks: 76, impressions: 3000, ctr: 2.53, position: 32.5 },
    { month: 'Mar 25', clicks: 99, impressions: 3600, ctr: 2.75, position: 29.8 },
    { month: 'Apr 25', clicks: 98, impressions: 3000, ctr: 3.27, position: 28.4 },
    { month: 'May 25', clicks: 121, impressions: 3400, ctr: 3.56, position: 30.5 },
    { month: 'Jun 25', clicks: 113, impressions: 3900, ctr: 2.90, position: 28.2 },
    { month: 'Jul 25', clicks: 103, impressions: 5200, ctr: 1.98, position: 36.4 },
    { month: 'Aug 25', clicks: 57, impressions: 7100, ctr: 0.80, position: 45.2 },
    { month: 'Sep 25', clicks: 73, impressions: 4400, ctr: 1.66, position: 37.1 },
    { month: 'Oct 25', clicks: 79, impressions: 2600, ctr: 3.04, position: 21.5 },
    { month: 'Nov 25', clicks: 89, impressions: 5300, ctr: 1.68, position: 21.3 }, // Best pos
    { month: 'Dec 25', clicks: 89, impressions: 4500, ctr: 1.98, position: 24.5 },
    { month: 'Jan 26', clicks: 10, impressions: 800, ctr: 1.25, position: 22.1 },
  ];

  // Raw Hourly Data from User (Meta Conversions API)
  const rawHourlyData = [
    { ts: '12/9 18:00', val: 54 }, { ts: '12/9 20:00', val: 18 },
    { ts: '12/10 7:00', val: 9 }, { ts: '12/10 18:00', val: 9 }, { ts: '12/10 19:00', val: 27 }, { ts: '12/10 21:00', val: 40 }, { ts: '12/10 22:00', val: 18 },
    { ts: '12/11 0:00', val: 9 }, { ts: '12/11 3:00', val: 36 }, { ts: '12/11 5:00', val: 9 }, { ts: '12/11 17:00', val: 9 },
    { ts: '12/12 17:00', val: 9 },
    { ts: '12/13 22:00', val: 9 },
    { ts: '12/14 23:00', val: 18 },
    { ts: '12/15 0:00', val: 18 }, { ts: '12/15 19:00', val: 18 }, { ts: '12/15 20:00', val: 17 },
    { ts: '12/16 11:00', val: 9 }, { ts: '12/16 12:00', val: 9 }, { ts: '12/16 18:00', val: 9 },
    { ts: '12/17 20:00', val: 17 },
    { ts: '12/18 5:00', val: 109 }, // PEAK
    { ts: '12/19 0:00', val: 9 },
    { ts: '12/21 16:00', val: 9 },
    { ts: '12/22 13:00', val: 36 }, { ts: '12/22 17:00', val: 36 },
    { ts: '12/23 3:00', val: 9 },
    { ts: '12/24 7:00', val: 27 }, { ts: '12/24 10:00', val: 27 }, { ts: '12/24 11:00', val: 9 },
    { ts: '12/25 11:00', val: 9 }, { ts: '12/25 13:00', val: 9 }, { ts: '12/25 14:00', val: 27 },
    { ts: '12/26 21:00', val: 9 }, { ts: '12/26 23:00', val: 9 },
    { ts: '12/27 23:00', val: 10 },
    { ts: '12/29 20:00', val: 9 },
    { ts: '12/30 1:00', val: 9 }, { ts: '12/30 9:00', val: 36 }, { ts: '12/30 11:00', val: 28 }, { ts: '12/30 18:00', val: 27 },
    { ts: '12/31 21:00', val: 27 },
    { ts: '1/1 14:00', val: 27 }, { ts: '1/1 20:00', val: 9 },
    { ts: '1/3 1:00', val: 18 }, { ts: '1/3 4:00', val: 9 }, { ts: '1/3 13:00', val: 19 },
    { ts: '1/4 2:00', val: 9 }, { ts: '1/4 20:00', val: 9 },
    { ts: '1/5 1:00', val: 18 }, { ts: '1/5 3:00', val: 18 }, { ts: '1/5 5:00', val: 27 }, { ts: '1/5 6:00', val: 27 }, { ts: '1/5 8:00', val: 9 },
    { ts: '1/6 11:00', val: 36 }, { ts: '1/6 14:00', val: 27 }
  ];
  ...
  const metrics = [
    { label: 'Total Clicks', value: '1,054', icon: MousePointer, color: 'text-blue-400' },
    { label: 'Total Impressions', value: '48,779', icon: Eye, color: 'text-indigo-400' },
    { label: 'Avg CTR', value: '2.28%', icon: Activity, color: 'text-emerald-400' },
    { label: 'Avg Position', value: '30.2', icon: Search, color: 'text-rose-400' },
  ];

  return (
    <div className="pt-24 pb-12 min-h-screen bg-slate-950 text-white">
      <Helmet>
        <title>Case Study: reallivebonsai.us SEO Performance | Zero Paid Ads Organic Growth</title>
        <meta name="description" content="Comprehensive SEO case study for reallivebonsai.us showing 12-month organic growth: 1000+ clicks, 48k+ impressions, and 21.3 average search position without paid advertising." />
      </Helmet>
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
            <div>
              ...
              <p className="text-xl text-slate-300 max-w-2xl">
                Google Search Console Performance Analysis: 12-Month Organic Growth
              </p>
            </div>
            <div className="flex items-center gap-2 bg-slate-900/50 px-4 py-2 rounded-full border border-slate-800">
              <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
              <span className="text-sm font-medium text-green-400">100% Organic • Zero Paid Ads</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          {/* Clicks Chart */}
          <ChartCard title="Organic Clicks per Month" subtitle="Peak: 121 clicks (May 2025)" color="blue">
            <ResponsiveLineChart 
              data={data} 
              dataKey="clicks" 
              color="#3b82f6" 
          ...
          {/* Impressions Chart */}
          <ChartCard title="Organic Impressions per Month" subtitle="Total: 48,779 impressions" color="indigo">
            <ResponsiveLineChart 
              data={data} 
              dataKey="impressions" 
              color="#6366f1" 
          ...
          {/* CTR Chart */}
          <ChartCard title="Click-Through Rate (CTR)" subtitle="Avg: 2.28% (vs 2.0% Baseline)" color="emerald">
            <ResponsiveLineChart 
              data={data} 
              dataKey="ctr" 
              color="#10b981" 
          ...
          {/* Position Chart */}
          <ChartCard title="Average Search Position" subtitle="Best: 21.3 (Lower is Better)" color="rose">
            <ResponsiveLineChart 
              data={data} 
              dataKey="position" 
              color="#f43f5e" 
        ...
        >
          <div className="mb-8">
            <h3 className="text-2xl font-bold text-white mb-2">Comprehensive Performance Timeline</h3>
            <p className="text-slate-400">Multi-metric correlation analysis over 12 months</p>
          </div>
...
const ResponsiveLineChart = ({ data, dataKey, color, maxY, fill, baseline, reversed = false }) => {
  return (
...
const ResponsiveBarChart = ({ data, dataKey, color }) => {
  ...
  return (
    <svg className="w-full h-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 100 100">
      ...
      {/* Max label */}
      <text x="0" y="5" fill="#94a3b8" fontSize="4">Peak: {maxVal}</text>
    </svg>
  );
};
...
const TimelineChart = ({ data }) => {
  ...
  return (
    <svg className="w-full h-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 100 100">
      ...
      {/* Paths */}
      <CombinedPath data={data} dataKey="impressions" max={8000} color="#6366f1" width="2" />
      <CombinedPath data={data} dataKey="clicks" max={140} color="#3b82f6" width="3" />
      <CombinedPath data={data} dataKey="ctr" max={5} color="#10b981" width="2" dash="4" />
