        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-300 mb-0">
                    Operating from Huntsville, Alabama—home to Cummings Research Park, the second-largest research park in the United States and historic birthplace of America's space program. Strategic positioning in the heart of defense, aerospace, and advanced technology innovation.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-300">
                    Currently running <strong>Real Live Bonsai</strong> (reallivebonsai.us) and <strong>Huntsville Drone</strong> (hsvdrone.com). Each business represents end-to-end execution: development, infrastructure, marketing automation, analytics, optimization.
                  </p>

                  <h3 className="text-xl font-semibold text-cyan-400 mb-2 mt-6">Full-Time Operations</h3>
                  <p className="text-slate-300">
                    Maintaining restaurant operations Tuesday through Saturday (2:30-10 PM) while simultaneously building and scaling digital operations. Parallel execution under real-world constraints.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-300 mb-4">
                    49 years old. No computer science degree. No bootcamp. Relentless learning, strategic tool selection, thousands of hours solving real problems on live systems. Proof of concept for results-driven execution without bureaucratic overhead.
                  </p>
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-8 mb-8">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-300 mb-4">
                    Not just "full-stack developer"—full-spectrum digital operator:
                  </p>
                  ...
                  <div className="grid gap-4">
                    <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
                      ...
                      <p className="text-slate-300 text-sm mb-0">
                        GTM strategy, SEO optimization, conversion tracking, iterative improvement based on actual user data.
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
                      ...
                      <p className="text-slate-300 text-sm mb-0">
                        Adobe expertise enables pixel-perfect implementation without designer dependencies. Git workflows enable continuous deployment without DevOps overhead.
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
                      ...
                      <p className="text-slate-300 text-sm mb-0">
                        Production-grade AI tool integration for content creation. Not just API calls—actually using these systems to ship faster.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-8 mb-8">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-300 mb-4">
                    <strong>Father and Author:</strong> "The Meaning(s) of Your LIFE! - A Father's Guide to His Daughter's Happiness" written for his daughter's 18th birthday.
                  </p>

                  <p className="text-slate-300 mb-4">
                    <strong>Philosophy:</strong> "God will move mountains for you, but you have to bring a shovel." Divine favor meets practical execution.
                  </p>

                  <p className="text-slate-300 mb-4">
                    <strong>Transportation:</strong> Cycles everywhere. Constraints breed creativity; dependencies breed fragility.
                  </p>

                  <p className="text-slate-300 mb-0">
                    <strong>Communication Style:</strong> Sardonic, self-deprecating, oniony layers of meaning. Direct business writing meets calculated wit. No corporate speak, no verbosity.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-emerald-900/20 to-cyan-900/20 border border-emerald-500/20 rounded-xl p-8 mb-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-300 mb-4">
                    After analyzing thousands of developers globally, Claude AI independently validated this capability set as top 1% worldwide. The combination of breadth, depth, and proven execution is statistically rare.
                  </p>
                  <p className="text-slate-300 mb-0">
                    Estimated ~1,000 people globally with comparable full-spectrum capability. In Huntsville? Likely the only one.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-8">
              ...
              <p className="text-slate-300 mb-4">
                Available for technical leadership roles in Huntsville's defense and aerospace sectors. Ideal fit for organizations needing:
              </p>
              <ul className="text-slate-300 space-y-2">
              ...
              <p className="text-slate-300 mt-6 mb-0">
                Not looking to be a cog. Looking to be the engine.
              </p>
            </div>
