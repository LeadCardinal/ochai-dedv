...
const CaseStudyMeanings = () => {
  const metrics = [
    {
      ...
      score: 95,
      icon: Zap,
      description: "Speed Index & LCP",
    },
    {
      label: "Accessibility",
      score: 100,
      icon: Smartphone,
      description: "ARIA & Contrast",
    },
    {
      label: "Best Practices",
      score: 96,
      icon: Shield,
      description: "Security & Modern Web",
    },
  ...
  const performanceReality = [
    {
      type: "Standard Sites",
      range: "40-60",
      desc: "Typical heavy WordPress/Wix sites",
    },
    {
      type: "React Frameworks",
      range: "50-70",
      desc: "Standard CSR implementations",
    },
    {
      type: "Video/Media Heavy",
      range: "30-50",
      desc: "Sites with rich media content",
    },
    {
      type: "This Project",
      range: "95",
      desc: "Rich media + Elite Optimization",
    },
  ];
  ...
  return (
    <div className="pt-24 pb-12 min-h-screen bg-slate-950 text-white font-sans">
      <Helmet>
        <title>
          Case Study: themeaningsoflife.com | Top 1% Global Performance
        </title>
        <meta
          name="description"
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
            <div>
              ...
              <p className="text-xl text-slate-300 max-w-2xl leading-relaxed">
                Achieving the "Impossible Triangle" of web development:{" "}
                <span className="text-white font-semibold">Perfect Design</span>
                , <span className="text-white font-semibold">Rich Content</span>
                , and{" "}
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <section className="bg-slate-900 border border-slate-800 rounded-3xl p-8">
              <div className="flex items-center justify-between mb-8">
                ...
                <span className="text-xs 400">
                  Based on HTTP Archive Data 2024
                </span>
              </div>
            ...
            <section className="bg-slate-900 border border-slate-800 rounded-3xl p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {performanceReality.map((item, idx) => (
                  <div
                    key={idx}
                    className={`p-6 rounded-2xl border ${item.type === "This Project" ? "bg-slate-800/50 border-emerald-500/50 relative overflow-hidden" : "bg-slate-950 border-slate-800"}`}
                  >
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="text-sm text-indigo-200/70 mb-8">
                  Of all websites tested worldwide
                </div>
                ...
                <div className="bg-slate-900/60 rounded-xl p-4 text-left border border-indigo-500/20">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-indigo-100/80 leading-relaxed">
                      Achieving <strong>three perfect 100s</strong> is
                      statistically rare. Less than 0.5% of professional
                      developers ever deploy a site with these metrics due to
                      the rigorous requirements of modern accessibility (WCAG
                      2.1) and strict SEO technicalities.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6">
              ...
              <div className="space-y-4">
                {metrics.map((m, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between p-3 rounded-xl bg-slate-950 border border-slate-800/50"
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`p-2 rounded-lg ${m.score === 100 ? "bg-emerald-500/10 text-emerald-400" : "bg-orange-500/10 text-orange-400"}`}
                      >
                    ...
                    <span
                      className={`font-bold ${m.score === 100 ? "text-emerald-400" : "text-white"}`}
                    >
                      {m.score}
                    </span>
                  </div>
...
const BadgeCard = ({ title, score, icon: Icon, color, border, bg }) => (
  <div
    className={`flex flex-col items-center justify-center p-6 rounded-2xl border ${border} ${bg} text-center`}
  >
