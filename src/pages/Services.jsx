...
const Services = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // ── Process steps — one card per scroll trigger, independent pins ──
  ...
  return (
    <>
      ...
      <section ref={stepSectionRef} className="relative z-10 bg-slate-900 overflow-hidden" style={{ minHeight: '100vh' }}>
