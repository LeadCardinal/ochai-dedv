...
const Home = () => {
  return (
    <>
      <Helmet>
        <title>Jeremy Och | AI Implementation Specialist & Full-Stack Developer | North Alabama</title>
        <link rel="canonical" href="https://ochai.dev/" />
        <meta name="title" content="Jeremy Och | AI Implementation Specialist & Full-Stack Developer | North Alabama" />
